...
/**
 * Local plugin "PackMule - sync Moodle to GAGI database exports" - Version file
 *
 * @package    local_packmule
 * @copyright  2023, Aureliano Martini (Liceo cantonale di Lugano 3) <aureliano.martini@edu.ti.ch>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

defined('MOODLE_INTERNAL') || die();

$plugin->component = 'local_packmule';
